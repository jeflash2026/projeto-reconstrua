...
> **Natureza:** documento de referência da FASE DE HOMOLOGAÇÃO. Define o *comportamento
> esperado* de cada módulo (o "deve"), para que a homologação compare **esperado × real**
...
*Documento de baseline. Nenhum código implementado, nenhum arquivo de produto alterado,
nenhum comportamento novo criado — apenas o esperado, consolidado das fontes existentes.*
