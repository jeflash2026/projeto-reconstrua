...
> **Data:** 2026-07-16 · **Princípio:** *"Nunca construir algo novo enquanto existir algo
> equivalente que possa ser reaproveitado."* Este plano não fala de módulos — fala de
...
- **As 19 regras de conduta da AHRI** → curar e carregar em produção (CAP-04) — *a maior
  economia do projeto: comportamento já escrito.*
...
- **O download do conteúdo de mídia** da Evolution (um único elo de integração; o *store* de
...
*Documento de reconstrução orientado a reaproveitamento. Nenhuma linha de código escrita;
nada alterado ou commitado.*
