          ...
          <div className="card">
            ...
            <details style={{ marginTop: 16 }}>
              ...
              <p className="page-sub" style={{ marginTop: 8 }}>
                ...
                escritório. Peça um novo link ao administrador — ao abri-lo, você define a nova
                senha na hora (a antiga deixa de valer). Depois é só entrar aqui com o seu CPF e a
                senha nova.
              </p>
            </details>
          </div>
