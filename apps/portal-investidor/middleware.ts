// ─────────────────────────────────────────────────────────────────────────────
// GATE DE AUTENTICAÇÃO do Portal do INVESTIDOR (2026-09-16): visitante →
// /login → painel. O cookie carrega `<cpf>.<HMAC>`; o middleware recompõe o
// HMAC (Web Crypto) com o segredo server-side. Fail-closed: sem segredo ⇒
// nenhum cookie é válido. /convite é público (o link do Admin cria a senha).
// ─────────────────────────────────────────────────────────────────────────────
import { NextResponse, type NextRequest } from 'next/server';

const SESSION_COOKIE = 'reconstrua_investidor';
const SESSION_MESSAGE = 'reconstrua-investidor-session-v1';
