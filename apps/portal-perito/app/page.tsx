...
const CentralPerito = async ({
  ...
  return (
    <>
      <FaixaTopo sub="Central do Perito" largura={1500}>
        <SairButton />
      </FaixaTopo>
      <main style={{ maxWidth: 1500, margin: '0 auto', padding: '20px 20px 48px' }}>
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <p className="page-sub" style={{ marginTop: 0 }}>
            Clientes com procuração assinada e documentação completa. Baixar o pacote inicia a
            perícia (10 dias).
          </p>
