...
export const ALIR_CLASSIFICATIONS = [
  'CANONICO',
  'DERIVADO',
  'CALCULADO',
  'TEMPORARIO',
...
export const ALIR_FIELDS: readonly ALIRFieldMeta[] = [
  // META
  {
    path: 'clienteId',
    section: 'META',
    description: 'Identidade do cliente (raiz do agregado).',
    classification: 'CANONICO',
    owner: 'r2-recognize-cliente',
    origin: 'identities (MissionIdentity.clienteId)',
    reconstructable: true,
  },
  {
    path: 'chatId',
    section: 'META',
    description: 'Chave de contato do cliente (WhatsApp).',
    classification: 'CANONICO',
    owner: 'r1-recognize-person',
    origin: 'identities (MissionIdentity.chatId)',
    reconstructable: true,
  },
  {
    path: 'projectedAt',
    section: 'META',
    description: 'Momento da recomposição da projeção.',
    classification: 'CALCULADO',
    owner: 'alir-runtime',
    origin: 'ALIR Runtime (recomposição)',
    reconstructable: true,
  },
  {
    path: 'schemaVersion',
    section: 'META',
    description: 'Versão do esquema do contrato ALIR.',
    classification: 'CALCULADO',
    owner: 'alir-runtime',
    origin: 'ALIR contract',
    reconstructable: true,
  },
  {
    path: 'contentHash',
    section: 'META',
    description: 'Hash do conteúdo projetado (versionamento/divergência).',
    classification: 'CALCULADO',
    owner: 'alir-runtime',
    origin: 'ALIR Runtime (hash do conteúdo)',
    reconstructable: true,
  },
  {
    path: 'healthScore',
    section: 'META',
    description: 'Saúde operacional do caso (derivada das órbitas).',
    classification: 'CALCULADO',
    owner: 'alir-runtime',
    origin: 'ALIR Runtime (derivado das órbitas)',
    reconstructable: true,
  },

  // CORE
  {
    path: 'core.pessoa.personId',
    section: 'CORE',
    description: 'Identidade da Pessoa reconhecida.',
    classification: 'CANONICO',
    owner: 'r2-recognize-cliente',
    origin: 'identities.personId / stream person',
    reconstructable: true,
  },
  {
    path: 'core.pessoa.identidadeCivil',
    section: 'CORE',
    description: 'Identidade civil opaca (DF-23).',
    classification: 'CANONICO',
    owner: 'r2-recognize-cliente',
    origin: 'stream person (CivilIdentity)',
    reconstructable: true,
  },
  {
    path: 'core.pessoa.origemReconhecimento',
    section: 'CORE',
    description: 'Origem do reconhecimento (DF-23).',
    classification: 'CANONICO',
    owner: 'r2-recognize-cliente',
    origin: 'stream person (RecognitionOrigin)',
    reconstructable: true,
  },
  {
    path: 'core.pessoa.atributos',
    section: 'CORE',
    description: 'Atributos lembrados da pessoa (nome, cidade…).',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.attributes',
    reconstructable: true,
  },

  // OPERATIONAL — missão
  {
    path: 'operational.missao.missionId',
    section: 'OPERATIONAL',
    description: 'Missão (caso) corrente.',
    classification: 'CANONICO',
    owner: 'mission-runtime',
    origin: 'identities.missionId',
    reconstructable: true,
  },
  {
    path: 'operational.missao.caseId',
    section: 'OPERATIONAL',
    description: 'Caso vinculado.',
    classification: 'CANONICO',
    owner: 'mission-runtime',
    origin: 'identities.caseId',
    reconstructable: true,
  },
  {
    path: 'operational.missao.processId',
    section: 'OPERATIONAL',
    description: 'Processo vinculado.',
    classification: 'CANONICO',
    owner: 'mission-runtime',
    origin: 'identities.processId',
    reconstructable: true,
  },
  {
    path: 'operational.missao.stageCode',
    section: 'OPERATIONAL',
    description: 'Etapa operacional atual.',
    classification: 'DERIVADO',
    owner: 'r6-operational-synthesis',
    origin: 'operational-stage / MissionSnapshot',
    reconstructable: true,
  },
  {
    path: 'operational.missao.stateCode',
    section: 'OPERATIONAL',
    description: 'Estado operacional atual.',
    classification: 'DERIVADO',
    owner: 'r6-operational-synthesis',
    origin: 'operational-state / MissionSnapshot',
    reconstructable: true,
  },
  {
    path: 'operational.missao.truthEstablished',
    section: 'OPERATIONAL',
    description: 'A Verdade Operacional já foi sintetizada.',
    classification: 'DERIVADO',
    owner: 'r6-operational-synthesis',
    origin: 'decision-state.truthEstablished',
    reconstructable: true,
  },
  {
    path: 'operational.missao.terminalState',
    section: 'OPERATIONAL',
    description: 'Estado terminal (ENCERRADA) quando encerrado.',
    classification: 'DERIVADO',
    owner: 'mission-runtime',
    origin: 'decision-state.terminalState (Close/Reopen)',
    reconstructable: true,
  },
  {
    path: 'operational.missao.progresso',
    section: 'OPERATIONAL',
    description: 'Passos de workflow atingidos.',
    classification: 'DERIVADO',
    owner: 'workflow-runtime',
    origin: 'workflow (MissionProgress.steps)',
    reconstructable: true,
  },
  {
    path: 'operational.missao.acompanhamento',
    section: 'OPERATIONAL',
    description: 'Acompanhamentos agendados/pendentes.',
    classification: 'TEMPORARIO',
    owner: 'scheduler-runtime',
    origin: 'scheduler (ScheduledTask)',
    reconstructable: true,
  },

  // OPERATIONAL — documentos
  {
    path: 'operational.documentos.enviados',
    section: 'OPERATIONAL',
    description: 'Documentos recebidos e vinculados.',
    classification: 'CANONICO',
    owner: 'r3-recognize-document',
    origin: 'document-link / stream document',
    reconstructable: true,
  },
  {
    path: 'operational.documentos.pendentes',
    section: 'OPERATIONAL',
    description: 'Documentos ainda pendentes (códigos).',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.documentsPending',
    reconstructable: true,
  },

  // OPERATIONAL — AHRI
  {
    path: 'operational.ahri.estiloConversa',
    section: 'OPERATIONAL',
    description: 'Estilo de conversa derivado.',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.conversationStyle',
    reconstructable: true,
  },
  {
    path: 'operational.ahri.tempoRespostaMedioMs',
    section: 'OPERATIONAL',
    description: 'Tempo médio de resposta do cliente.',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.avgResponseMs',
    reconstructable: true,
  },
  {
    path: 'operational.ahri.primeiroContatoAt',
    section: 'OPERATIONAL',
    description: 'Primeiro contato do cliente.',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.firstContactAt',
    reconstructable: true,
  },
  {
    path: 'operational.ahri.ultimoContatoAt',
    section: 'OPERATIONAL',
    description: 'Último contato do cliente.',
    classification: 'DERIVADO',
    owner: 'living-memory',
    origin: 'client-memory.lastContactAt',
    reconstructable: true,
  },
  {
    path: 'operational.ahri.qualidade',
    section: 'OPERATIONAL',
    description: 'Sinal de qualidade do atendimento (Shadow).',
    classification: 'EXTERNO',
    owner: 'shadow',
    origin: 'shadow (ShadowReport)',
    reconstructable: true,
  },

  // OPERATIONAL — operação
  {
    path: 'operational.operacao.handoffsAbertos',
    section: 'OPERATIONAL',
    description: 'Escalonamentos humanos abertos.',
    classification: 'CANONICO',
    owner: 'human-handoff-runtime',
    origin: 'handoff (HandoffTask)',
    reconstructable: true,
  },
  {
    path: 'operational.operacao.atribuicao',
    section: 'OPERATIONAL',
    description: 'Atribuição do caso a advogado.',
    classification: 'CANONICO',
    owner: 'administrador',
    origin: 'assignments (CaseAssignment)',
    reconstructable: true,
  },
  {
    path: 'operational.operacao.responsaveis',
    section: 'OPERATIONAL',
    description: 'Responsáveis alocados ao caso.',
    classification: 'CANONICO',
    owner: 'administrador',
    origin: 'staff (StaffMember)',
    reconstructable: true,
  },

  // OPERATIONAL — jurídico
  {
    path: 'operational.juridico.processoRef',
    section: 'OPERATIONAL',
    description: 'Referência do processo (nº).',
    classification: 'CANONICO',
    owner: 'advogado',
    origin: 'stream process / juridical',
    reconstructable: true,
  },
  {
    path: 'operational.juridico.pendencias',
    section: 'OPERATIONAL',
    description: 'Pendências jurídicas (prazos/documentos).',
    classification: 'CANONICO',
    owner: 'advogado',
    origin: 'juridical (JuridicalEntry)',
    reconstructable: true,
  },

  // OPERATIONAL — timeline / decisões / próxima ação
  {
    path: 'operational.timeline',
    section: 'OPERATIONAL',
    description: 'Histórico de eventos do cliente.',
    classification: 'CANONICO',
    owner: 'event-store',
    origin: 'event store (streams do cliente)',
    reconstructable: true,
  },
  {
    path: 'operational.decisoes',
    section: 'OPERATIONAL',
    description: 'Decisões registradas (auditoria).',
    classification: 'CANONICO',
    owner: 'event-store',
    origin: 'decisions / event store',
    reconstructable: true,
  },
  {
    path: 'operational.proximaAcao',
    section: 'OPERATIONAL',
    description: 'Próxima melhor ação para o caso.',
    classification: 'CALCULADO',
    owner: 'executive-brain',
    origin: 'NextBestActionPlanner (Brain)',
    reconstructable: true,
  },

  // EXTENSIONS — slots sem produtor hoje (declarados, nunca inventados)
  {
    path: 'extensions.pericia',
    section: 'EXTENSIONS',
    description: 'Laudo/resultado da perícia.',
    classification: 'CANONICO',
    owner: 'pending-producer',
    origin: 'ausente — nasce em W1-03',
    reconstructable: true,
  },
  {
    path: 'extensions.estagioComercial',
    section: 'EXTENSIONS',
    description: 'Estágio no funil comercial (1→12).',
    classification: 'DERIVADO',
    owner: 'pending-producer',
    origin: 'ausente — nasce em W1-04',
    reconstructable: true,
  },
  {
    path: 'extensions.comercial',
    section: 'EXTENSIONS',
    description: 'Situação comercial (venda/sociedade).',
    classification: 'CANONICO',
    owner: 'pending-producer',
    origin: 'ausente — nasce em Onda 2/3',
    reconstructable: true,
  },
  {
    path: 'extensions.financeiro',
    section: 'EXTENSIONS',
    description: 'Situação financeira (honorário/distribuição/a receber).',
    classification: 'CANONICO',
    owner: 'pending-producer',
    origin: 'ausente — nasce em Onda 3',
    reconstructable: true,
  },
  {
    path: 'extensions.escritorio',
    section: 'EXTENSIONS',
    description: 'Escritório parceiro vinculado.',
    classification: 'CANONICO',
    owner: 'pending-producer',
    origin: 'ausente — nasce em Onda 2',
    reconstructable: true,
  },
  {
    path: 'extensions.portalCliente',
    section: 'EXTENSIONS',
    description: 'Situação do portal do cliente.',
    classification: 'EXTERNO',
    owner: 'pending-producer',
    origin: 'ausente — nasce no futuro',
    reconstructable: true,
  },
];
