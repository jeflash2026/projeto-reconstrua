...
export const clienteEntityInvariants: ReadonlyArray<Invariant<ClienteAggregate>> = [
  defineInvariant<ClienteAggregate>({
    ...
    description:
      'Todo Cliente é a condição de uma Pessoa reconhecida (referência obrigatória à Pessoa).',
...
export const CLIENTE_INVARIANTS_MANIFEST: ReadonlyArray<ClienteInvariantSpec> = [
  {
    id: 'INV-CL-01',
    canonReference: 'Entidade 02; DF-23',
    description: 'Todo cliente é uma Pessoa reconhecida.',
    enforcement: 'entity',
  },
  {
    id: 'INV-CL-02',
    canonReference: 'INV-P02',
    description:
      'Jamais cria uma segunda Pessoa; o mesmo indivíduo corresponde a uma única Pessoa.',
    enforcement: 'entity',
  },
  {
    id: 'INV-CL-03',
    canonReference: 'Entidade 02 — Identidade Civil',
    description: 'A condição de cliente não altera a identidade civil da Pessoa.',
    enforcement: 'entity',
  },
];
