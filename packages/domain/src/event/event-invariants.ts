...
export const EVENT_INVARIANTS_MANIFEST: ReadonlyArray<EventInvariantSpec> = [
  { id: 'INV-EV-01', canonReference: 'DF-14', description: 'Classificação obrigatória no ato — Relevante ou Informativo (subtipos exaustivos).', enforcement: 'entity' },
  { id: 'INV-EV-02', canonReference: 'DF-05; INV-08', description: 'Somente Evento Relevante altera estado; Informativo jamais.', enforcement: 'projection' },
  { id: 'INV-EV-03', canonReference: 'E12-L09', description: 'Evento Relevante exige Fato reconhecido que o fundamente.', enforcement: 'entity' },
  { id: 'INV-EV-04', canonReference: 'Lei 2; INV-E12-05', description: 'Vinculado a exatamente uma Missão; reconhecimentos independentes por missão.', enforcement: 'entity' },
  { id: 'INV-EV-05', canonReference: 'Lei 3; DF-11', description: 'Um Evento reconhecido jamais é apagado.', enforcement: 'event-store' },
];
