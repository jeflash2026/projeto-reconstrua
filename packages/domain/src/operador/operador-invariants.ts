...
export const OPERADOR_INVARIANTS_MANIFEST: ReadonlyArray<OperadorInvariantSpec> = [
  { id: 'INV-OPr-01', canonReference: 'Lei Geral', description: 'Responsabilidade temporária; a missão pertence ao Projeto, jamais ao Operador.', enforcement: 'entity' },
  { id: 'INV-OPr-02', canonReference: 'DF-09', description: 'Não pratica ato privativo de advogado/perito; não decide juridicamente.', enforcement: 'entity' },
  { id: 'INV-OPr-03', canonReference: 'Art. 12º', description: 'A transição de designação preserva contexto integralmente.', enforcement: 'use-case' },
];
