...
export const OPERATIONAL_STAGE_INVARIANTS_MANIFEST: ReadonlyArray<OperationalStageInvariantSpec> = [
  {
    id: 'INV-ET-01',
    canonReference: 'Lei 2; mapeamento 1:1',
    description: 'Corresponde a exatamente um Estado vigente (bijeção 1:1).',
    enforcement: 'entity',
  },
  {
    id: 'INV-ET-02',
    canonReference: 'DF-08',
    description: 'Jamais diverge do Estado; apresenta fielmente, jamais o altera.',
    enforcement: 'cross-entity',
  },
  {
    id: 'INV-ET-03',
    canonReference: 'Lei 2',
    description: 'Uma Etapa por missão por instante (decorre de INV-EO-01 via bijeção).',
