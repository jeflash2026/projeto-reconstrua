...
export const operationalStateEntityInvariants: ReadonlyArray<Invariant<OperationalStateAggregate>> = [
  defineInvariant<OperationalStateAggregate>({
    ...
    description: 'O Estado deriva exclusivamente da Verdade Operacional (fonte única e obrigatória).',
...
export const OPERATIONAL_STATE_INVARIANTS_MANIFEST: ReadonlyArray<OperationalStateInvariantSpec> = [
  { id: 'INV-EO-01', canonReference: 'Lei 2', description: 'Exatamente um Estado por missão por instante; jamais dois simultâneos.', enforcement: 'event-store' },
  { id: 'INV-EO-02', canonReference: 'INV-02; DF-08', description: 'Deriva exclusivamente da Verdade Operacional; jamais fonte autônoma.', enforcement: 'entity' },
  { id: 'INV-EO-03', canonReference: 'DF-05; DF-14', description: 'Muda somente por evolução (R6), via Evento Relevante.', enforcement: 'use-case' },
  { id: 'INV-EO-04', canonReference: 'DF-08; DF-03; Lei 1', description: 'Jamais alterado por interface; nenhum dashboard o recalcula.', enforcement: 'cqrs' },
];
