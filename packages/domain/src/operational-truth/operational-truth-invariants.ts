...
export const OPERATIONAL_TRUTH_INVARIANTS_MANIFEST: ReadonlyArray<OperationalTruthInvariantSpec> = [
  {
    id: 'INV-VO-01',
    canonReference: 'E8-L03',
    description:
      'Exatamente uma Verdade vigente por missão por instante; anteriores permanecem como histórico datado.',
    enforcement: 'event-store',
  },
  {
    id: 'INV-VO-02',
    canonReference: 'Lei 1; DF-02',
    description: 'Fonte única de estado operacional no Sistema; jamais duas verdades oficiais.',
    enforcement: 'cross-entity',
  },
  {
    id: 'INV-VO-03',
    canonReference: 'DF-08',
    description: 'Nenhuma interface produz ou altera a Verdade; toda tela a consome.',
    enforcement: 'cqrs',
  },
  {
    id: 'INV-VO-04',
    canonReference: 'INV-E8-03; Lei 3; DF-11',
    description: 'Histórico das sínteses é perpétuo; nenhuma Verdade anterior é apagada.',
    enforcement: 'event-store',
  },
  {
    id: 'INV-VO-05',
    canonReference: 'DF-03',
    description: 'Agregações e KPIs são métricas derivadas, jamais a Verdade Operacional.',
