...
export const PERSON_INVARIANTS_MANIFEST: ReadonlyArray<PersonInvariantSpec> = [
  {
    id: 'INV-P01',
    canonReference: 'Entidade 02; Identidade Civil',
    description:
      'Identidade única e permanente; mudanças cadastrais/documentais jamais criam nova Pessoa.',
    enforcement: 'entity',
  },
  {
    id: 'INV-P02',
    canonReference: 'Entidade 02; Lei 1',
    description: 'Jamais duplicada: o mesmo indivíduo real corresponde a exatamente uma Pessoa.',
    enforcement: 'event-store',
  },
  {
    id: 'INV-P03',
    canonReference: 'DF-08; Lei 2',
    description: 'Nunca possui Estado, Etapa, Workflow nem Timeline Operacional (são da MISSÃO).',
    enforcement: 'entity',
  },
  {
    id: 'INV-P04',
    ...
    description:
      'Possui zero, uma ou múltiplas missões; cada missão sua pertence exatamente a ela.',
  ...
  },
  {
    ...
    description:
      'Nunca pertence ao Sistema; o Sistema apenas administra missões relacionadas a ela.',
    enforcement: 'entity',
  },
  {
    id: 'INV-P06',
    canonReference: 'Art. 6º',
    description:
      'Nenhuma decisão a reduz a identificador; preserva dignidade, transparência, segurança, respeito.',
    enforcement: 'entity',
  },
  {
    id: 'INV-P07',
    canonReference: 'DF-11; Lei 3',
    description: 'Vínculos com suas missões jamais apagados; nenhuma missão sua desaparece.',
    enforcement: 'event-store',
  },
  {
    id: 'INV-P08',
    canonReference: 'Entidade 02 — Identidade Civil',
    description:
      'A representação operacional jamais altera, constitui ou substitui a identidade civil.',
    enforcement: 'entity',
  },
  {
    id: 'INV-P09',
    canonReference: 'Lei 3; Art. 14º',
    description: 'Toda alteração da representação operacional é rastreável.',
    enforcement: 'use-case',
  },
  {
    id: 'INV-P10',
    canonReference: 'Lei 2',
    description: 'A Pessoa pode visualizar todas as suas missões.',
  ...
  {
    id: 'INV-P12',
    canonReference: 'DF-20; Lei da Individualidade',
    description:
      'Interesses compartilhados jamais geram missão comum: sempre missões independentes.',
    enforcement: 'cross-entity',
  },
  {
    id: 'INV-P13',
    canonReference: 'DF-11',
    description: 'A Pessoa nunca é encerrada; somente missões se encerram.',
    enforcement: 'entity',
  },
  {
    id: 'INV-P14',
    canonReference: 'DF-23',
    description: 'Nenhum reconhecimento incompleto (seis elementos obrigatórios).',
    enforcement: 'entity',
  },
  {
    id: 'INV-P15',
    canonReference: 'Lei do Reconhecimento',
    description: 'Nenhuma implementação trata a Pessoa como objeto criado pelo software.',
    enforcement: 'entity',
  },
];
