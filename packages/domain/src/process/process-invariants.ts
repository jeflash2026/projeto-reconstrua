...
export const PROCESS_INVARIANTS_MANIFEST: ReadonlyArray<ProcessInvariantSpec> = [
  { id: 'INV-PR-01', canonReference: 'DF-10', description: 'Todo Processo pertence a uma Missão; não existe Processo fora de Missão.', enforcement: 'entity' },
  { id: 'INV-PR-02', canonReference: 'DF-10; Art. 7º', description: 'O Processo nunca é a Missão (é instrumento, um dos caminhos para cumpri-la).', enforcement: 'entity' },
  { id: 'INV-PR-03', canonReference: 'DF-10', description: 'A Missão pode existir sem Processo (o Processo não é obrigatório à Missão).', enforcement: 'cross-entity' },
];
