...
export const projectionEntityInvariants: ReadonlyArray<Invariant<ProjectionAggregate>> = [
  defineInvariant<ProjectionAggregate>({
    ...
    description:
      'Deriva da Verdade (fonte obrigatória) e jamais a substitui/recalcula como verdade.',
...
export const PROJECTION_INVARIANTS_MANIFEST: ReadonlyArray<ProjectionInvariantSpec> = [
  {
    id: 'INV-PJ-01',
    canonReference: 'DF-03; INV-E8-04',
    description:
      'Toda projeção deriva da Verdade e jamais a substitui, reinterpreta ou recalcula como verdade.',
    enforcement: 'entity',
  },
  {
    id: 'INV-PJ-02',
    canonReference: 'DF-08',
    description: 'Nunca altera o Estado Operacional (não o conhece nem o referencia).',
    enforcement: 'entity',
  },
];
