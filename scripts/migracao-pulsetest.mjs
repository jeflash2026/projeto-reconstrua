...
const CLIENTES = [
  {
    pulse: 2,
    nome: 'IRANITE BRITO DONINI',
    sexo: 'Feminino',
    cpfCnpj: '080.810.868-97',
    rg: '20355689-6',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 99280-9134',
    celular1: '(17) 98121-9214',
    endereco: {
      logradouro: 'Rua Buritama',
      numero: '2341',
      bairro: 'Eldorado',
      cep: '15043-350',
  ...
  {
    pulse: 3,
    nome: 'EDNA LUCIA MELHORATO DA SILVA',
    sexo: 'Feminino',
    rg: '261753058',
    orgaoEmissor: 'SSP/SP',
    ufEmissao: 'SP',
    telefone: '(18) 99625-4392',
    endereco: {
      logradouro: 'Rua Altino Arantes',
      numero: '1620',
      bairro: 'Centro',
      cep: '15260-000',
      cidade: 'Planalto',
  ...
  {
    pulse: 6,
    nome: 'ELIAS FIRMINO DE LIMA',
    cpfCnpj: '051.033.318-45',
    rg: '166922924',
    orgaoEmissor: 'SSP/SP',
    endereco: {
      logradouro: 'Rua dos Driussi',
      numero: '107',
      bairro: 'J.D Vanessa',
      cep: '15970-000',
      cidade: 'Santa Ernertisna',
      uf: 'SP',
    },
  },
  {
    pulse: 7,
    nome: 'IZETE MARQUES DE MELO BRONZATTI',
    sexo: 'Feminino',
    cpfCnpj: '018.701.728-09',
    rg: '8822822-8',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 99164-5594',
    endereco: {
      logradouro: 'Rua André Giantomassi',
      numero: '5099',
      bairro: 'Centro',
      cep: '15350-000',
      cidade: 'Auriflama',
  ...
  {
    pulse: 8,
    nome: 'FLAVIA APARECIDA LIMA RODRIGUES',
    sexo: 'Feminino',
    cpfCnpj: '286.762.418-56',
    rg: '354977064',
    orgaoEmissor: 'SSP/SP',
    telefone: '(18) 99819-9877',
    endereco: {
      logradouro: 'Rua dos Miosotis',
      numero: '215',
      bairro: 'J.d Campos Verdes',
      cep: '16360-000',
    },
  },
  {
    pulse: 9,
    nome: 'NIVALDO GONÇALVES GOMES',
    sexo: 'Masculino',
    cpfCnpj: '214.837.794-91',
    rg: '15982767-X',
    orgaoEmissor: 'SSP/SP',
    endereco: {
      logradouro: 'Rua dos Sinibaldi',
      numero: '22',
      bairro: 'J. Vanessa',
      cep: '15970-000',
    },
  ...
  {
    pulse: 10,
    nome: 'FRANCINETE NOGUEIRA DE QUEIROZ GUEDE',
    sexo: 'Feminino',
    cpfCnpj: '025.924.798-31',
    rg: '189734723',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 99104-0328',
    endereco: {
      logradouro: 'Av. Fortunado Ernesto Vetorazzo',
      numero: '4598',
      cep: '15130-000',
      cidade: 'Mirassol',
      uf: 'SP',
  ...
  {
    pulse: 11,
    nome: 'ORLANDO DOMINGUES DA CUNHA',
    observacoes: 'Registro duplicado vindo do sistema antigo (sem documento).',
  },
  {
    pulse: 12,
    nome: 'ORLANDO DOMINGUES DA CUNHA',
    cpfCnpj: '350.381.878-20',
    rg: '5964990-2',
    endereco: {
      logradouro: 'Rua Capitão Vicente Gonçalves',
      numero: '467',
      bairro: 'Centro',
      cep: '15280-000',
      cidade: 'Turiuba',
  ...
  {
    pulse: 13,
    nome: 'MARIA APARECIDA MARTINS DE ATTAIDE VICENTE',
    sexo: 'Masculino',
    cpfCnpj: '366.234.151-49',
    rg: '317626',
    orgaoEmissor: 'SSP/SP',
    endereco: {
  ...
  {
    pulse: 14,
    nome: 'Sirlei Dornellas Nogara',
    cpfCnpj: '033.883.728-02',
    rg: '173652566',
    orgaoEmissor: 'SSP/SP',
    telefone: '(18) 99630-4646',
    endereco: {
      logradouro: 'Rua Porangaba',
      numero: '683',
  ...
  {
    pulse: 15,
    nome: 'Hildebrando José Marques',
    sexo: 'Masculino',
    cpfCnpj: '523.237.658-68',
    rg: '39703964',
    endereco: {
      logradouro: 'Rua Walter Sternieri',
      numero: '402',
      bairro: 'P.q Nova Esperança',
      cep: '15047-371',
      cidade: 'São Jose do Rio Preto',
      uf: 'SP',
    },
  ...
  {
    pulse: 16,
    nome: 'Lucia Helena Dias',
    cpfCnpj: '137.086.158-32',
    rg: '23713365-9',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 99768-1009',
    endereco: {
      logradouro: 'Rua Samuel de Almeida',
      numero: '373',
      bairro: 'Coab 4',
      cep: '15290-000',
      cidade: 'Buritama',
  ...
  {
    pulse: 17,
    nome: 'Natalia Aparecida de Oliveira',
    sexo: 'Feminino',
    cpfCnpj: '036.645.528-14',
    rg: '12251516-X',
    orgaoEmissor: 'SSP/SP',
    endereco: {
  ...
  {
    pulse: 18,
    nome: 'Francinete Nogueira de Queiróz Guedes',
    sexo: 'Feminino',
    cpfCnpj: '025.924.738-31',
    rg: '189734723',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 99104-0328',
    endereco: {
      logradouro: 'Av F. Ernesto',
      numero: '4598',
      bairro: 'Aeroporto',
      cep: '15130-000',
      cidade: 'Mirassol',
  ...
  {
    pulse: 19,
    nome: 'Cristina Callo da Silva Girotto',
    sexo: 'Feminino',
    cpfCnpj: '060.422.098-76',
    rg: '17618688-8',
    orgaoEmissor: 'SSP/SP',
    telefone: '(17) 98141-3709',
    endereco: {
      logradouro: 'R. Dr. Luiz Garcia de Figueiredo',
      numero: '1510',
      bairro: 'Conj. Hab Floriano Rissi',
      cep: '15130-000',
      cidade: 'Mirassol',
      uf: 'SP',
    },
...
const b = (banco, ...contratos) => ({
  banco,
  contratos: contratos.map(([numero, valor]) => ({ numero, valor: valor ?? '' })),
});
const PROCESSOS = [
  {
    pulse: 12,
    numero: '0000534-95.2010.8.26.0097',
    bancos: [b('Banco do Brasil S/A', ['150078731', 'R$ 719,46'])],
  },
  {
    pulse: 16,
    numero: '1000872-03.2020.8.26.0097',
    bancos: [
      b(
        'Banco Safra S/A',
        ['000009160199', 'R$ 222,40'],
        ['000010802225', 'R$ 222,40'],
        ['00005754959', 'R$ 222,40'],
      ),
    ],
  },
  {
    pulse: 7,
    numero: '1001004-69.2023.8.26.0060',
    bancos: [
      b('Banco Itaú Consignado S.A.', ['560363805', 'R$ 614,41'], ['566466131', 'R$ 614,41']),
    ],
  },
  {
    pulse: 8,
    numero: '1002007-94.2020.8.26.0438',
    bancos: [b('Banco Bradesco Financiamento S/A', ['812337235', 'R$ 89,71'])],
  },
  {
    pulse: 3,
    numero: '1002129-58.2023.8.26.0097',
    bancos: [b('Banco Bradesco Financiamentos S/A', ['806068135', 'R$ 44,41'])],
  },
  {
    pulse: 3,
    numero: '1002130-43.2023.8.26.0097',
    bancos: [b('Banco Safra S/A', ['000007405972', 'R$ 200,26'])],
  },
  {
    pulse: 3,
    numero: '1002131-28.2023.8.26.0097',
    bancos: [b('Itaú Unibanco S/A', ['620542210', 'R$ 52,25'])],
  },
  {
    pulse: 3,
    numero: '1002132-13.2023.8.26.0097',
    bancos: [b('BANCO C6 CONSIGNADO S.A.', ['010001971246', 'R$ 26,42'])],
  },
  {
    pulse: 3,
    numero: '1002344-34.2023.8.26.0097',
    bancos: [b('Banco Pan S/A', ['0229012112130', 'R$ 39,40'])],
  },
  {
    pulse: 17,
    numero: '1002659-28.2024.8.26.0097',
    bancos: [b('Banco Pan S/A', ['346999793-1', 'R$ 794,70'])],
  },
  {
    pulse: 6,
    numero: '1003069-38.2025.8.26.0619',
    bancos: [b('Banco C6 Consignado S.A.', ['010119028916', 'R$ 2.646,00'])],
  },
  {
    pulse: 6,
    numero: '1003070-23.2025.8.26.0619',
    bancos: [b('Banco Santander (Brasil) S/A', ['873701123-2', 'R$ 75,90'])],
  },
  {
    pulse: 6,
    numero: '1003072-90.2025.8.26.0619',
    bancos: [b('BANCO DAYCOVAL S.A.', ['53-1455104/22', 'R$ 75,90'])],
  },
  {
    pulse: 3,
    numero: '1003243-95.2024.8.26.0097',
    bancos: [
      b('Banco Bradesco Financiamento S/A', ['815691140']),
      b('Banco C6 S/A', ['010018914575']),
      b('Banco Pan S/A', ['764271008-6']),
      b('Bnpp - Banco Bnp Paribas Brasil S.a.', ['22-822203257/17']),
      b('Itaú Unibanco S/A', ['633050221']),
    ],
  },
  {
    pulse: 3,
    numero: '1003244-80.2024.8.26.0097',
    bancos: [
      b('Banco Bradesco Financiamento S/A', ['592175030']),
      b('Bnpp - Banco Bnp Paribas Brasil S.a.', ['51-829585910/18']),
      b('Itaú Unibanco S/A', ['636549905']),
    ],
  },
  {
    pulse: 3,
    numero: '1003247-35.2024.8.26.0097',
    bancos: [
      b(
        'Bnpp - Banco Bnp Paribas Brasil S.a.',
        ['22-732817/13310'],
        ['742241130'],
  ...
  {
    pulse: 3,
    numero: '1003253-42.2024.8.26.0097',
    bancos: [
      b('Banco Bnp Paribas Brasil S/A', ['22-429439/15310']),
      b('Banco Bradesco Financiamentos S/A', ['804143988']),
    ],
  },
  {
    pulse: 3,
    numero: '1003536-65.2024.8.26.0097',
    bancos: [
      b(
      ...
      b('Banco Pan S/A', ['0229014507284'], ['310976672-9']),
      b('Banco Safra S/A', ['000015285614'], ['000015666921'], ['000090044393']),
      b('Banco Santander (Brasil) S/A', ['188311738'], ['228690742']),
      b('Itaú Unibanco S/A', ['46998181/11999']),
    ],
  },
  {
    pulse: 3,
    numero: '1003540-10.2021.8.26.0097',
    bancos: [b('BANCO ITAU CONSIGNADO S.A.', ['592811100', 'R$ 471,09'])],
  },
  {
    pulse: 3,
    numero: '1003542-77.2021.8.26.0097',
    bancos: [b('Banco Bradesco Financiamento S/A', ['810473752', 'R$ 1.580,79'])],
  },
  {
    pulse: 3,
    numero: '1003543-62.2021.8.26.0097',
    bancos: [b('Banco Safra S/A', ['000090012190', 'R$ 5.561,43'])],
  },
  {
    pulse: 3,
    numero: '1003546-17.2021.8.26.0097',
    bancos: [b('Banco Pan S/A', ['0229014928948', 'R$ 1.171,25'])],
  },
  {
    pulse: 18,
    numero: '1005086-25.2023.8.26.0358',
    bancos: [b('Itaú Unibanco S/A', ['638203930', 'R$ 24,00'])],
  },
  {
    pulse: 14,
    numero: '1005995-12.2022.8.26.0032',
    bancos: [b('Banco BNP Paribas Brasil S/A - BNPP', ['51-836082044/19'])],
  },
  {
    pulse: 13,
    numero: '1007236-60.2025.8.26.0664',
    bancos: [
      b('BANCO C6 CONSIGNADO S.A.', ['010017139882', 'R$ 28,20'], ['010115656302', 'R$ 28,20']),
    ],
  },
  {
    pulse: 15,
    numero: '1008641-62.2024.8.26.0084',
    bancos: [b('Banco Agibank S.A.', ['1516062016', 'R$ 2.084,99'])],
  },
  {
    pulse: 10,
    numero: '1013658-86.2024.8.26.0405',
    bancos: [b('BANCO BRADESCO FINANCIAMENTOS S/A.', ['337411898-6', 'R$ 1.747,20'])],
  },
  {
    pulse: 2,
    numero: '1027784-86.2024.8.26.0003',
    bancos: [b('Banco Itau Consignado S.A.', ['545955922', 'R$ 2.910,59'])],
  },
  {
    pulse: 2,
    numero: '1034983-62.2024.8.26.0003',
    bancos: [b('Banco Itau Consignado S.A.', ['47330598', 'R$ 1.280,69'])],
  },
  {
    pulse: 2,
    numero: '1035493-73.2022.8.26.0576',
    bancos: [b('Banco do Estado do Rio Grande do Sul S.a.', ['08326779', 'R$ 7.352,64'])],
  },
  {
    pulse: 2,
    numero: '1044377-23.2024.8.26.0576',
    bancos: [b('Banco do Estado do Rio Grande do Sul - Banrisul', ['08326827', 'R$ 2.532,43'])],
  },
  {
    pulse: 2,
    numero: '1044379-90.2024.8.26.0576',
    bancos: [b('BANCO ITAU CONSIGNADO S.A.', ['557604583', 'R$ 605,31'])],
  },
  {
    pulse: 3,
    numero: '1102769-60.2023.8.26.0100',
    bancos: [b('BANCO C6 CONSIGNADO S.A.', ['010013563551'])],
  },
  {
    pulse: 3,
    numero: '1102791-21.2023.8.26.0100',
    bancos: [b('Itaú Unibanco S/A', ['559734623'])],
  },
  {
    pulse: 3,
    numero: '1102842-32.2023.8.26.0100',
    bancos: [b('BANCO SAFRA S.A.', ['000007686044', 'R$ 200,26'])],
  },
  {
    pulse: 3,
    numero: '1102863-08.2023.8.26.0100',
    bancos: [b('Banco C6 Consignado S/A', ['010013658598', 'R$ 49,64'])],
  },
  {
    pulse: 19,
    numero: '1155986-81.2024.8.26.0100',
    bancos: [b('BANCO SAFRA S/A', ['000003510622', 'R$ 741,68'])],
  },
  {
    pulse: 2,
    numero: '1157020-91.2024.8.26.0100',
    bancos: [b('Banco BMG S.A.', ['11503293', 'R$ 58,25'])],
  },
  {
    pulse: 2,
    numero: '1157021-76.2024.8.26.0100',
    bancos: [b('BANCO SANTANDER (BRASIL) S.A.', ['154928449', 'R$ 429,81'])],
  },
  {
    pulse: 2,
    numero: '1157022-61.2024.8.26.0100',
    bancos: [b('Banco do Estado do Rio Grande do Sul S.a - Banrisul', ['08326894', 'R$ 2.430,54'])],
  },
  {
    pulse: 9,
    numero: '4000499-91.2026.8.26.0619',
    bancos: [b('BANCO DAYCOVAL S.A.', ['55-7540223/20', 'R$ 8.514,59'])],
  },
];

const g = (processo, nome, valor, mes, advogado = '', andamento = '') => ({
  processo,
  nome,
  valor,
  mes,
...
const GUIAS = [
  ...
  g(
    '1013658-86.2024.8.26.0405',
    'Francinete Nogueira de Queiróz Guedes',
    'R$ 8.963,27',
    'Fevereiro',
  ),
  ...
  g(
    '1001898-80.2020.8.26.0438',
    'Tereza Rosa Maria Pinheiro Pardim da Silva',
    'R$ 6.000,00',
    'Novembro',
  ),
  g('0006976-46.2020.8.26.0576', 'J.B.O. J.H.O. J.R.O', 'R$ 45.370,45', 'Novembro', '', 'Acordo'),
  g(
    '0046096-93.2025.8.26.0100',
    'Cleidemar dos Santos Pereira Strazzeri',
    'R$ 11.557,47',
    'Novembro',
  ),
  ...
  g(
    '0022128-34.2025.8.26.0100',
    'Cleuza Ramalheiro Benedito',
    'R$ 16.292,95',
    'Janeiro',
    '',
    'Nenhum',
  ...
  g(
    '1000717-97.2020.8.26.0097',
    'Quiteria Ferreira dos Reis',
    'R$ 44.750,94',
    'Janeiro',
    '',
    'Nenhum',
  ...
  g(
    '0004440-58.2025.8.26.0068',
    'Luiz Aparecido Ferreira da Silva',
    'R$ 32.314,60',
    'Dezembro',
    '',
    'Nenhum',
  ...
  g(
    '0004601-68.2025.8.26.0068',
    'Maria de Lourdes Alcantra da Silva',
    'R$ 16.542,31',
    'Dezembro',
    '',
    'Nenhum',
  ...
  g(
    '1001813-94.2020.8.26.0438',
    'Junia Cristiane Moreira de Souza',
    'R$ 1.980,90',
    'Dezembro',
    '',
    'Nenhum',
  ...
  g(
    '0000582-73.2025.8.26.0438',
    'Helena da Silva Paixão',
    'R$ 16.542,31',
    'Dezembro',
    '',
    'Nenhum',
  ...
  g(
    '0001257-89.2025.8.26.0097',
    'Francisca Brito da Costa',
    'R$ 23.239,29',
    'Dezembro',
    '',
    'Nenhum',
...
(async () => {
  ...
  if ((atual.clientes ?? 0) > 0) {
    console.log(
      `ABORTADO: o painel já tem ${atual.clientes} cliente(s) — a migração só roda em painel vazio (evita duplicar).`,
    );
    return;
  }
  ...
  console.log('');
  console.log(
    `MIGRAÇÃO CONCLUÍDA: ${mapa.size}/16 clientes · ${contratos}/65 contratos · ${guiasOk}/93 guias · ${PERICIAS.length} perícia.`,
  );
})();
